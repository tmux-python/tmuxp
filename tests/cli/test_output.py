...
class TestOutputMode:
    ...
    def test_output_mode_members(self) -> None:
...
class TestGetOutputMode:
    """Tests for get_output_mode function."""
...
class TestOutputFormatter:
    ...
    def test_json_buffer_initially_empty(self) -> None:
...
class TestOutputFormatterEmit:
    """Tests for OutputFormatter.emit method."""

    def test_emit_json_buffers_data(self) -> None:
...
class TestOutputFormatterEmitText:
    """Tests for OutputFormatter.emit_text method."""

    def test_emit_text_human_outputs(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_emit_text_json_silent(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_emit_text_ndjson_silent(self, capsys: pytest.CaptureFixture[str]) -> None:
...
class TestOutputFormatterFinalize:
    """Tests for OutputFormatter.finalize method."""

    def test_finalize_json_outputs_array(
        self, capsys: pytest.CaptureFixture[str]
    ) -> None:
    ...
    def test_finalize_json_clears_buffer(self) -> None:
    ...
    def test_finalize_human_no_op(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_finalize_ndjson_no_op(self, capsys: pytest.CaptureFixture[str]) -> None:
...
class TestOutputFormatterIntegration:
    ...
    def test_json_workflow(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_ndjson_workflow(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_human_workflow(self, capsys: pytest.CaptureFixture[str]) -> None:
