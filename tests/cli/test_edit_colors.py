...
def test_edit_opening_message_format(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_edit_file_path_uses_info(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_edit_editor_highlighted(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_edit_muted_for_static_text(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_edit_colors_disabled_plain_text() -> None:
...
def test_edit_various_editors(monkeypatch: pytest.MonkeyPatch) -> None:
